    ...
    routes: [
        {
            ...
            children: [
                {
                    path: 'payment',
                    component: () => import('../components/client/payment gateway/ShoppingCart.vue'),
                    name: 'payment'
                }
            ]
        },
        ...
        {
            path: '/payment',
            component: () => import('../components/client/payment gateway/MangoPayment.vue'),
            children: [
                {
                    path: '',
                    component: () => import('../components/client/payment gateway/PaymentGateway.vue'),
                    name: 'payment'
                },
                {
                    path: 'shoppingCart',
                    component: () => import('../components/client/payment methods/PaymentMethods.vue'),
                    name: 'shoppingCart'
                },
            ]
        },
